...
Before the recent resurrection of neural networks and their success, SVMs were the some of the most popular classifiers in the machine learning community. The math behind them is rich and connects to results in functional analysis such as the Mercer theorem and Reproducing Hilbert Kernel Space. Unlike a logistic regression, they have no problems handling situations where the classes are perfectly separated.
...
class determined by the sign of $h(x) = \beta x +\beta_0$.
